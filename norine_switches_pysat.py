...
if __name__ == "__main__":         
    ...
    encoding = encode(N, b, prime, deg_constraint)
    filename = f"norine_switches_pysat_{N}_{b}{'_prime' if prime else ''}{'_deg' + str(deg_constraint) if deg_constraint is not None else ''}.cnf"
    encoding.to_file(filename)
