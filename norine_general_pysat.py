...
def encode(n, sum_upper_bound, fprime=False, deg_constraint=None, partial_sym_break=None):
    """
...
if __name__ == "__main__":         
    ...
    argparser.add_argument("--check-conjecture", action='store_true', help="Check conjecture, i.e., whether a variant of the Conjecture holds for the given parameters") # TODO 
    ...
    encoding, var_to_edge = encode(N, args.b, fprime=args.fprime, partial_sym_break=args.partial_sym_break)
